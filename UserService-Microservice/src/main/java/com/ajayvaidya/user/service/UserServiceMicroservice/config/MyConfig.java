package com.ajayvaidya.user.service.UserServiceMicroservice.config;

import com.ajayvaidya.user.service.UserServiceMicroservice.config.interceptor.RestTemplateInterceptor;
...
public class MyConfig {
    ...
    //declare the bean of Oauth2AuthorizedManager
    @Bean
